...
| Build và kiểm tra | `flutter-template/build-preview.ps1`, `test/` | build_runner, build/copy preview và 32 test (template, finance, mobile roles, architecture); generated output không sửa trực tiếp |
