...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Bill&&(identical(other.total, _this.total) || other.total == _this.total)&&(identical(other.paid, _this.paid) || other.paid == _this.paid));
}
...
int get hashCode {
  final _this = this as Bill;
  return Object.hash(runtimeType,_this.total,_this.paid);
}

@override
String toString() {
  final _this = this as Bill;
  return 'Bill(total: ${_this.total}, paid: ${_this.paid})';
}
...
/// Create a copy of Bill
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? total = null,Object? paid = null,}) {
  return _then(Bill(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int total,  int paid)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Bill() when $default != null:
return $default(_that.total,_that.paid);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int total,  int paid)  $default,) {final _that = this;
switch (_that) {
case _Bill():
return $default(_that.total,_that.paid);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int total,  int paid)?  $default,) {final _that = this;
switch (_that) {
case _Bill() when $default != null:
return $default(_that.total,_that.paid);case _:
  return null;
...
class _Bill extends Bill {
  const _Bill({required this.total, required this.paid}): super._();
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Bill&&(identical(other.total, total) || other.total == total)&&(identical(other.paid, paid) || other.paid == paid));
}


@override
int get hashCode {
    return Object.hash(runtimeType,total,paid);
}

@override
String toString() {
    return 'Bill(total: $total, paid: $paid)';
}
...
/// Create a copy of Bill
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? total = null,Object? paid = null,}) {
  return _then(_Bill(
total: null == total ? _self.total : total // ignore: cast_nullable_to_non_nullable
as int,paid: null == paid ? _self.paid : paid // ignore: cast_nullable_to_non_nullable
as int,
