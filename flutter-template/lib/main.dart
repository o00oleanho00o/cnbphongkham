...
class PemaApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    home: _Root(store: store, enableFinance: enableFinance),
  );
}
...
class _Root extends StatefulWidget {
  final DemoStore store;
  final bool enableFinance;
  const _Root({required this.store, this.enableFinance = false});
  @override
  State<_Root> createState() => _RootState();
}

class _RootState extends State<_Root> {
  // Onboarding tạm tắt — đổi lại false để bật.
  bool onboarded = true;
  @override
  Widget build(BuildContext context) => onboarded
      ? Workspace(store: widget.store, enableFinance: widget.enableFinance)
      : OnboardingFlow(onComplete: () => setState(() => onboarded = true));
}
...
class _WorkspaceState extends State<Workspace> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedIcons = care
        ? [Icons.home, Icons.route, Icons.chat_bubble, Icons.person]
        : [
    ...
    return Scaffold(
      ...
      bottomNavigationBar: PemaBottomNav(
        labels: labels,
        icons: icons,
